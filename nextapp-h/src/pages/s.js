...
export default function FilterSection() {
  ...
  return (
    <section className="border p-6 rounded-lg shadow-md max-w-3xl mx-auto">
      ...
      {/* ✅ Second Row (Dropdown & More Filters) */}
          ...
          {showCalendar && (
            <div className="absolute z-10 bg-white shadow-md rounded mt-2 p-4">
              ...
              <div className="mt-2 space-y-1">
                {["Today", "Tomorrow", "This Month", "Next Month"].map(
                  (option) => (
                    <Button
                      key={option}
                      fullWidth
      ...
      <div className="flex justify-between mt-6">
        ...
        <Button color="danger" onClick={handleReset} isDisabled={!search && !location && !category && !type && !selectedDate}>
          Reset
        </Button>
      </div>
    </section>
